...
import { ensureArrearPaymentTables } from "./models/arrearPaymentModel.js";
...
import { ensureEmployeeAdvanceTables } from "./models/employeeAdvanceModel.js";
import { ensureFiscalYearsTable } from "./models/fiscalYearModel.js";
import { ensureJournalTables } from "./models/journalModel.js";
...
import { ensureEmployeeScaleHistoryTable, ensureEmployeesTable, ensureEmployeeStatusHistoryTable } from "./models/employeeModel.js";
import { ensureMprocessTables } from "./models/mprocessModel.js";
import { ensurePayrollTables } from "./models/payrollModel.js";
import { ensureTaxSlabTables } from "./models/taxSlabModel.js";
import { ensurePayrollTaxSnapshotTables } from "./models/payrollModel.js";
import { ensureTransactionTables } from "./models/transactionModel.js";
...
import arrearPaymentRoutes from "./routes/arrearPaymentRoutes.js";
...
import employeeAdvanceRoutes from "./routes/employeeAdvanceRoutes.js";
import mprocessRoutes from "./routes/mprocessRoutes.js";
import proofReportRoutes from "./routes/proofReportRoutes.js";
import payrollRoutes from "./routes/payrollRoutes.js";
import { chequePrintRouter, exportRouter, specialPayRouter } from "./routes/transactionRoutes.js";
...
app.use("/api/arrear-payments", arrearPaymentRoutes);
...
app.use("/api/reports", proofReportRoutes);
app.use("/api/mprocess", mprocessRoutes);
app.use("/api/payroll", payrollRoutes);
app.use("/api/special-pay", specialPayRouter);
app.use("/api/cheque-print", chequePrintRouter);
app.use("/api/exports", exportRouter);
app.use("/api/allowances", allowanceRoutes);
app.use("/api/departments", departmentRoutes);
app.use("/api/designations", designationRoutes);
app.use("/api/fiscal-years", fiscalYearRoutes);
app.use("/api/tax-policies", taxSlabRoutes);
